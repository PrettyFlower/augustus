...
static translation_string all_strings[] = {
    ...
    {TR_TOOLTIP_BUTTON_ACCEPT_WORKERS, "停止將資源運送至作坊或糧倉"},
    ...
    {TR_CITY_MESSAGE_SQUALOR, "恶劣的居住条件和帐篷是個大問題"},
    {TR_FIGURE_TYPE_LIGHTHOUSE_SUPPLIER, "燈塔看守人"},
    {TR_WINDOW_GAMES_NO_WATER_ACCESS, "維納絲未接觸到貯水池。"},
    {TR_HOTKEY_COPY_SETTINGS, "復制建造設置" },
    {TR_HOTKEY_PASTE_SETTINGS, "粘貼建造設置" },
    {TR_WINDOW_ADVISOR_RELIGION_LARARIUMS, "城市裏的神龕" },
    ...
    {TR_BUILDING_HIPPODROME_NEEDS_WORKERS, "賽馬場人手不足，為了給市民提供精彩絕倫的娛樂表演，你需要更多工人。"},
    {TR_BUILDING_LIGHTHOUSE_NEEDS_WORKERS, "燈塔人手不足，無法確保燈火長明。貿易船只費力地尋找著通往你方城市港口的路線。"},
    ...
    {TR_BUILDING_TAVERN_DESC_5, "市民空閑之余喜歡前來社交，或享受附帶葡萄酒的午飯。" },
