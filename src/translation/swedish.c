...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_BONUS_DESC, "Neptunus välsignar köpmannakaravaner samt handelsskepp med 50% mer kapacitet, och inspirerar även öpmannakaravaner att röra sig 25% snabbare." },
    ...
    {TR_ADVISOR_SICKNESS_LEVEL_LOW, "Ytterst få sjukdomar sprids i staden. Stadens hygiennivå förhindrar att epedemier sprids hit från andra städer."},
    {TR_ADVISOR_SICKNESS_LEVEL_MEDIUM, "Några smittsamma sjukdomar har spridit sig i staden, men läget är under kontroll. Förbättra stadens hygiennivå för att mildra epedemiers påverkan över staden."},
    {TR_ADVISOR_SICKNESS_LEVEL_HIGH, "Många smittsamma sjukdomar sprider sig i delar av staden. Om du inte gör något åt det snart, kommer några byggnader kanske behöva sättas i karantän. Bättre tillgång till sjukvård skulle häjda epedemier från att bryta ut."},
    {TR_ADVISOR_SICKNESS_LEVEL_PLAGUE, "Pesten drabbar staden! Många invånare insjuknar och byggnader kan ha suttits i karantän, eller bränts ned för att förhindra att plågan sprids. De få tillgängliga läkare och kirurger i staden inkallas för att decinficera områden drabbade av epedemin. Situation måste åtgärdas!"},
    {TR_TOOLTIP_OVERLAY_SICKNESS_LOW, "Väldigt får sjukdomar"},
    ...
    {TR_CITY_WARNING_DATA_COPY_NOT_SUPPORTED, "Kan inte kopiera från denna byggnad. Can't copy from this building" },
